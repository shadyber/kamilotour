...
@section('content')
    ...
    <form action="/destination" method="post" class="form-horizontal form-material" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group mb-4">
            <div class="col-sm-12">
                <button class="btn btn-success">Post Destination</button>
            </div>
        </div>
    </form>
